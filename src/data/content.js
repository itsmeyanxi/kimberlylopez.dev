...
export const projects = [
...

  {
    ...
    team: 'Two developers',
    what:
      'SOPOD is an internal system we use at Meatplus for purchasing and finance. It covers sales orders and deliveries, and the process from purchase requests and purchase orders through receiving and approval, AP invoices, requests for payment, and check vouchers.',
    cardSummary:
...
export const experience = [
  {
    ...
    location: 'United Nation, Manila',
    current: true,
    bullets: [
      'Co-develop internal systems used across production, warehouse, purchasing, and finance operations.',
      'Build backend and frontend features using Laravel/PHP, MySQL/MariaDB, JavaScript, Blade, Tailwind CSS, and Alpine.js, including backend logic, database operations, validation, and user interfaces.',
      'Work with another developer on feature delivery, debugging, testing, reporting, document generation, data import/export, and role-based access.',
    ],
